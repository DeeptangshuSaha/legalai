...
if __name__ == "__main__":
    ...
    # document_name = 'Corporate Law and Compliance'
    # document_description = 'Corporate laws in India'
    # text = pdf_to_text(utils.INDIAN_CORPORATE_ACT)
    document_name = "Labour Act"
    document_description = "Labour acts in India"
    text = pdf_to_text(utils.INDIAN_ACT_URL)
